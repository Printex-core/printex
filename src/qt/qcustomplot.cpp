...
/*!
  ...
  message. This is also the case if for other reasons the define flag QT_NO_PRTXER is set.
...
bool QCustomPlot::savePdf(const QString &fileName, bool noCosmeticPen, int width, int height, const QString &pdfCreator, const QString &pdfTitle)
{
  ...
  Q_UNUSED(width)
  Q_UNUSED(height)
  qDebug() << Q_FUNC_INFO << "Qt was built without printer support (QT_NO_PRTXER). PDF not created.";
#else
