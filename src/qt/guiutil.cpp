...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("Printex://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "Printex:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Printex-Qt") + " " + tr("version") + " " +
